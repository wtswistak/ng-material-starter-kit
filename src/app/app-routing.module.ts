...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'crypto-table', component: CryptoListComponent }, { path: 'products-search', component: ProductComponent }, { path: 'public-holidays', component: HolidayListComponent }, { path: 'list-1-single-table-names', component: NamesComponent }, { path: 'categories', component: CategoryListComponent }, { path: 'job-post-table', component: JobComponent }, { path: 'list-1-multi-gird-list-jobs', component: JobsGridComponent }, { path: 'list-1-nested-list-influencers', component: InfluComponent }, { path: 'form-1-control-name', component: FormComponent }, { path: 'form-1-control-age', component: FormAgeComponent }]), CryptoListComponentModule, ProductComponentModule, HolidayListComponentModule, NamesComponentModule, CategoryListComponentModule, JobComponentModule, JobsGridComponentModule, InfluComponentModule, FormComponentModule, FormAgeComponentModule],
